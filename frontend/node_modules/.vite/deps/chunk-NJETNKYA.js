...
var Link = Link_1 = class Link2 extends UI5Element_default {
  ...
  onBeforeRendering() {
    const needsNoReferrer = this.target === "_blank" && this.href && this._isCrossOrigin(this.href);
...
ExpandableText = ExpandableText_1 = __decorate3([
  customElement_default({
...
export {
  ...
  LinkDesign_default,
  Link_default,
  ExpandableText_default
};
//# sourceMappingURL=chunk-NJETNKYA.js.map

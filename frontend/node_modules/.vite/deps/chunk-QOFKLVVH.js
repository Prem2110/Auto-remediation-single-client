...
var detachLanguageChange = (listener) => {
  eventProvider2.detachEvent(LANG_CHANGE, listener);
};
...
var attachConfigurationReset = (listener) => {
  eventProvider5.attachEvent(CONFIGURATION_RESET, listener);
};
var resetConfiguration = () => {
  eventProvider5.fireEvent(CONFIGURATION_RESET, void 0);
};
...
var attachBoot = (listener) => {
  if (!booted) {
    eventProvider6.attachEvent("boot", listener);
    return;
  }
  listener();
};
...
//# sourceMappingURL=chunk-QOFKLVVH.js.map
